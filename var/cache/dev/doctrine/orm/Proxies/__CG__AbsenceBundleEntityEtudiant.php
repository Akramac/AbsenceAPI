 ...
 */
class Etudiant extends \AbsenceBundle\Entity\Etudiant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AbsenceBundle\\Entity\\Etudiant' . "\0" . 'classe', '' . "\0" . 'AbsenceBundle\\Entity\\Etudiant' . "\0" . 'absences', '' . "\0" . 'AbsenceBundle\\Entity\\Etudiant' . "\0" . 'id', '' . "\0" . 'AbsenceBundle\\Entity\\Etudiant' . "\0" . 'nom'];
        }
